...
# anything real.
#
# Apache listens on :80, which is NOT opened by openclaw-nsg in 01-core
# (3389 and 22 only). That is deliberate: the page is reachable from the desktop's own
# browser and nothing else. Add an ingress rule for 80 only if you want it
